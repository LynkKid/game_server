...
namespace GameServer.KiemThe.Core.Rechage
{
    public class RechageServiceManager
    {
        ...
        public static void SendRequestByThreading(byte[] SendDATA, NPC npc, KPlayer client)
        {
            ...
            string Text = "Xin chào <b>" + client.RoleName + "</b>" + " bạn hiện có  <b>" + KTGlobal.CreateStringByColor(client.KTCoin + " HKCoin", ColorType.Yellow) + "</b>\n\nVui lòng chọn gói " + KTGlobal.CreateStringByColor("Đồng", ColorType.Green) + " muốn quy đổi dưới đây\nLần mua đầu tiên sẽ nhận khuyến mại " + KTGlobal.CreateStringByColor("Đồng Khóa", ColorType.Green) + " tương ứng với gói " + KTGlobal.CreateStringByColor("Đồng", ColorType.Green) + " quy đổi\n<b><color=red>Bạn phải quy đổi tối thiểu 2000 HKCOIN để nhận được quà nạp đầu</color></b>\nSau khi mua hết các gói khuyến mại bạn có thể sử dụng chức năng ĐỔI TÙY CHỌN để nhập số HKCOIN muốn đổi với tỉ lệ 1:1";
            ...
            if (Check1 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack1, "<b><color=#00ff2a>Gói 5000 Đồng</color></b> cần <b>5000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack1, "<b><color=#00ff2a>Gói 5000 Đồng</color></b> cần <b>5000 HKCoin</b>");
            }

            if (Check2 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack2, "<b><color=#00ff2a>Gói 1 vạn Đồng</color></b> cần <b>10000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack2, "<b><color=#00ff2a>Gói 1 vạn Đồng</color></b> cần <b>10000 HKCoin</b>");
            }

            if (Check3 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack3, "<b><color=#00ff2a>Gói 2 vạn Đồng</color></b> cần <b>20000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack3, "<b><color=#00ff2a>Gói 2 vạn Đồng</color></b> cần <b>20000 HKCoin</b>");
            }

            if (Check4 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack4, "<b><color=#00ff2a>Gói 5 vạn Đồng</color></b> cần <b>50000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack4, "<b><color=#00ff2a>Gói 5 vạn Đồng</color></b> cần <b>50000 HKCoin</b>");
            }

            if (Check5 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack5, "<b><color=#00ff2a>Gói 10 vạn Đồng</color></b> cần <b>100000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack5, "<b><color=#00ff2a>Gói 10 vạn Đồng</color></b> cần <b>100000 HKCoin</b>");
            }

            if (Check6 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack6, "<b><color=#00ff2a>Gói 20 vạn Đồng</color></b> cần <b>200000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack6, "<b><color=#00ff2a>Gói 20 vạn Đồng</color></b> cần <b>200000 HKCoin</b>");
            }
			if (Check7 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack7, "<b><color=#00ff2a>Gói 50 vạn Đồng</color></b> cần <b>500000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack7, "<b><color=#00ff2a>Gói 50 vạn Đồng</color></b> cần <b>500000 HKCoin</b>");
            }

            if (Check8 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack8, "<b><color=#00ff2a>Gói 100 vạn Đồng</color></b> cần <b>1000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack8, "<b><color=#00ff2a>Gói 100 vạn Đồng</color></b> cần <b>1000000 HKCoin</b>");
            }

            if (Check9 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack9, "<b><color=#00ff2a>Gói 200 vạn Đồng</color></b> cần <b>2000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack9, "<b><color=#00ff2a>Gói 200 vạn Đồng</color></b> cần <b>2000000 HKCoin</b>");
            }

            if (Check10 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack10, "<b><color=#00ff2a>Gói 500 vạn Đồng</color></b> cần <b>5000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack10, "<b><color=#00ff2a>Gói 500 vạn Đồng</color></b> cần <b>5000000 HKCoin</b>");
            }

            if (Check11 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack11, "<b><color=#00ff2a>Gói 700 vạn Đồng</color></b> cần <b>7000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack11, "<b><color=#00ff2a>Gói 700 vạn Đồng</color></b> cần <b>7000000 HKCoin</b>");
            }

            if (Check12 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack12, "<b><color=#00ff2a>Gói 1000 vạn Đồng</color></b> cần <b>10000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack12, "<b><color=#00ff2a>Gói 1000 vạn Đồng</color></b> cần <b>10000000 HKCoin</b>");
            }

            /// if (Check13 == -1)
            /// {
                /// Selections.Add((int)RecoreDef.IAP_Pack13, "<b><color=#00ff2a>Gói 2000 vạn Đồng</color></b> cần <b>20000000 HKCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            /// }
            /// else
            /// {
                /// Selections.Add((int)RecoreDef.IAP_Pack13, "<b><color=#00ff2a>Gói 2000 vạn Đồng</color></b> cần <b>20000000 HKCoin</b>");
            /// }
